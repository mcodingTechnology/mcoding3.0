...
public class ProductQrcodeTemplateExample {
    ...
    protected PageView<ProductQrcodeTemplate> pageView;

    public ProductQrcodeTemplateExample() {
        oredCriteria = new ArrayList<Criteria>();
    }

    public PageView<ProductQrcodeTemplate> getPageView() {
		return pageView;
	}

	public void setPageView(PageView<ProductQrcodeTemplate> pageView) {
