...
public class WxUserTagsExample implements IExample<WxUserTags> {
    ...
    protected PageView<WxUserTags> pageView;

    public WxUserTagsExample() {
    ...
    @Override
    public PageView<WxUserTags> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<WxUserTags> pageView) {
