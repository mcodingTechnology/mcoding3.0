...
public class MemberPurseBalanceExample implements IExample<MemberPurseBalance> {
    ...
    protected PageView<MemberPurseBalance> pageView;

    public MemberPurseBalanceExample() {
    ...
    @Override
    public PageView<MemberPurseBalance> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<MemberPurseBalance> pageView) {
