...
public class IncomeMonthExample implements IExample<IncomeMonth> {
    ...
    protected PageView<IncomeMonth> pageView;

    public IncomeMonthExample() {
    ...
    @Override
    public PageView<IncomeMonth> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<IncomeMonth> pageView) {
