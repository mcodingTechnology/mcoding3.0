...
public class IncomeOrderProductExample implements IExample<IncomeOrderProduct> {
    ...
    protected PageView<IncomeOrderProduct> pageView;

    public IncomeOrderProductExample() {
    ...
    @Override
    public PageView<IncomeOrderProduct> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<IncomeOrderProduct> pageView) {
