...
public class QRCodeUserExample implements IExample<QRCodeUser> {
    ...
    protected PageView<QRCodeUser> pageView;

    public QRCodeUserExample() {
    ...
    @Override
    public PageView<QRCodeUser> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<QRCodeUser> pageView) {
