        	...
        	if (data.status == 0) {
                ...
                if (isFocusStatus == 0) {
                    return buijs_modal({
                        ...
                        content: ("<div class='bui_ta_c bui_plr_32' style='margin-top: 10px;margin-bottom: 10px;'>"+
                                        "<img style='width: 165px;vertical-align: middle;margin-right: 10px;display: block;margin: 8px auto;' src='images/gymmaxer_forcus.png'></div>"+
        		...
        		buijs_modal({
                    ...
                    content: ("<div class='bui_ta_c bui_plr_25' style='margin-top: 20px;margin-bottom: 15px;'>"+
                                    "<p class='bui_ptb_25'><i class='fa fa-check-circle-o bui_fas_96 bui_fac_red'></i></p>"+
                ...
                buijs_modal_close();
                  buijs_modal({
                        ...
                        "<p class='bui_ptb_32'><i class='fa fa-exclamation-circle bui_fas_96 bui_fac_red'></i></p>"+
                        "<p>"+data.msg+"</p>"+
               ...
               buijs_modal({
                    ...
                    footer: ('<div class="bui_ta_c bui_p_24">'+
                                                '<button onclick="validateSecurityCodeInfo()" class="bui_btn_48 bui_block '+vueObj.style.btnTrue+' bui_round" >立即积分</button>'+
                                            '</div>'),
                    positions: 'center',
                    width: '90%',
                    height: '400px'
