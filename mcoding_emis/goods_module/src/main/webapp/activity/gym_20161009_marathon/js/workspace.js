...
//生产环境
if(_domain.indexOf('gymmaxer.com') >= 0) {
	console.log('生产环境');
	//baidiui
	_baidiui = _domain + '/resources/baidiui_v2.0.3/';
	//Jsonurl
	_jsonUrl = _domain + '/';
	//生产环境公众号appid
...
//阿里云测试环境
	...
	console.log('阿里云测试环境');
	//baidiui
	_baidiui = _domain + '/goods_module/resources/baidiui_v2.0.3/';
	//Jsonurl
...
//测试环境
	...
	//Jsonurl
	//		_jsonUrl = 'http://192.168.2.87:7080/goods_module/';
	_jsonUrl = 'http://newmou.com/goods_module/';
	//	_jsonUrl = 'http://hzywx.wicp.net/goods_module/';
	//openid
...
//微信分享
document.write('<script type="text/javascript" src="../../../resources/js/common/wechatShare.js"></script>');