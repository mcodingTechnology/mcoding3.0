    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i>游戏奖品列表
                </div>
            </div>
            <div class="portlet-body">
            	<div id="edit" class="table-toolbar">
					<div class="btn-group">
						<span id="addGamePrizeView" href="addGamePrizeView.html" class="ajaxify">
							<span class="btn green fileinput-button"> <i
								class="fa fa-plus"></i><span>添加游戏奖品</span>
						</span>
						</span>
					</div>
				</div>
...
<script src="${basePath}resources/js/custom/game/gamePrizeList.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->

<script type="text/javascript">
game_gamePrizeList.init();
</script>
