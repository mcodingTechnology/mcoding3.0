    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i>游戏答题和抽奖结果列表
                </div>
            </div>
            <div class="portlet-body">
            	<!--<div id="edit" class="table-toolbar">
					<div class="btn-group">
						<span id="addGameQuestion" href="addGameQuestionView.html" class="ajaxify">
							<span class="btn green fileinput-button"> <i
								class="fa fa-plus"></i><span>添加游戏题目</span>
						</span>
						</span>
					</div>
				</div> -->
                  <div id="edit" class="table-toolbar">
                  	<form id="searchForm" class="form-horizontal" action="#">
                         ...
                         <div class="col-md-3">
                             <select id="gameid" name="gameid" style="float: right;margin-bottom:10px;"
...
<script src="${basePath}resources/js/custom/game/gameMemberResultList.js" type="text/javascript"></script>
