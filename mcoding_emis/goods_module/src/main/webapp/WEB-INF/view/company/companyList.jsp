	...
	<div class="col-md-12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-globe"></i>企业内购列表
				</div>
			</div>
			<div class="portlet-body">
				<div class="form-group">
					<div class="col-md-4" >
						<select class="form-control input-large select2me" name="companyId" id="selectCompanyId" ></select>
					</div>
					<div class="col-md-3">
				...
				<div id="edit" class="table-toolbar" style="margin-top:60px;">
					<div class="btn-group">
						<span id="addCompany" class="ajaxify" href="addCompanyPageView.html">
							<span class="btn green fileinput-button">
								<i class="fa fa-plus"></i><span>添加内购企业</span>
							</span>
						</span>
					</div>
				</div>
...
<script
	src="${basePath}resources/js/custom/company/companyList.js"
