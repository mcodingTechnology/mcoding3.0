...
<div class="header navbar navbar-fixed-top">
    ...
    <div class="header-inner">
        ...
        <a class="navbar-brand" href="index.html" style="margin-top:5px;">
            <img id="index_iconImg" src="${basePath}resources/images/top_logo2.png" alt="logo" class="img-responsive" style="margin-top:-13px;max-width:130%;"/>
        </a>
        <!-- END LOGO -->
		...
		$.ajax({
            ...
            success: function (data) {
               if(data.queryResult.length > 0){
            	   var img = data.queryResult[1].img;
            	   if(img){
            		   $("#index_iconImg").removeAttr("src");
            		   $("#index_iconImg").attr({ src: img});
            	   }
               }
            }
        });
