		...
		<div class="portlet box blue">
			...
			<div class="portlet-body">
				<div class="form-group">
					 <div class="col-md-4" >
						<input type="text" name="selectWarehouseName" id="selectWarehouseName" class="form-control input-inline input-medium" placeholder="请输标签名称">
					</div>
					<div class="col-md-3">
				...
				<div id="edit" class="table-toolbar" style="margin-top:60px;">
					<div class="btn-group">
						<span id="addCompany" class="ajaxify" href="addLabel.html">
...
<!-- BEGIN PAGE LEVEL SCRIPTS -->
 <script
	src="${basePath}resources/js/custom/label/labelPointList.js"
