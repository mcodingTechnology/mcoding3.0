...
<div class="row">
	<div class="col-md-12">
		<h3 class="page-title">关键词列表</h3>
		<!-- BEGIN EXAMPLE TABLE PORTLET-->
		<div class="portlet box yellow">
			<div class="portlet-body">
				<div id="edit" class="table-toolbar">
					<div class="btn-group">
						<span id="addArticleDef" href="page/addKeywordPage.html"
							class="ajaxify"> <span class="btn green fileinput-button">
								<i class="fa fa-plus"></i><span>添加关键词</span>
						</span>
						</span>
					</div>
				</div>
				...
				<!-- <form id="articleDefSearchForm" class="form-horizontal" action="#">
					<div class="col-md-3">
						<input type="text" name="keyword"
							class="form-control input-inline input-medium" placeholder="关键词">
					</div>
				</form>
...
<script
	src="${basePath}resources/js/custom/investigation/keywordList.js"
