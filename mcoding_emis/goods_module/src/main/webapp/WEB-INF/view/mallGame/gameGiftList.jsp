					...
					<div class="btn-group">
						<span id="addGameView" href="addGameView.html" class="ajaxify">
							<span class="btn green fileinput-button"> <i
								class="fa fa-plus"></i><span>添加商城游戏活动</span>
						</span>
						</span>
					</div>
				</div>
...
<script src="${basePath}resources/js/custom/mallGame/mallGameList.js" type="text/javascript"></script>
