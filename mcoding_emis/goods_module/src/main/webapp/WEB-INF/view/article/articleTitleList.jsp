		...
		<div class="portlet box yellow">
			<div class="portlet-body">
				<div id="edit" class="table-toolbar">
					<div class="btn-group">
						<span id="addArticleDef" href="page/addArticleTitle.html" class="ajaxify">
							<span class="btn green fileinput-button"> 
							<i class="fa fa-plus"></i><span>添加分类</span>
							</span>
						</span>
					</div>
				</div>
			...
			<form id="articleDefSearchForm" class="form-horizontal" action="#">
				<div class="col-md-3">
					<select id="flag" name="flag" class="input-medium form-control select2me">
						<!-- <option value="1" selected>数据价值网</option>
						<option value="2">印奈儿</option> -->
						<option value="3">牛么</option>
					</select>
				</div>
			</form>
...
<script src="${basePath}resources/js/custom/article/articleTitleList.js"
