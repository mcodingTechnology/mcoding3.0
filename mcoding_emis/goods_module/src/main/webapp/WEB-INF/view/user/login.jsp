...
<div class="all">
	<div class="mainDiv">
		<div class="header">
			...
			<!-- <div style="margin-top:20px;    display: none;"><h1><span style="color:#ff6b00;">SCRM</span>&nbsp;运营平台</h1></div> -->
		</div>
				...
				<form action="loginForSpringSecurity" method="post" class="loginDiv" id="loginForm">
					...
					<ul>
							<li>
								...
								<input id="j_username" name="j_username" class="username" type="text" placeholder="用户名" />
							</li>
							<li>
								<img src="resources/images/password.png" alt=""/>
								<input id="j_password" name="j_password" class="password" type="password" placeholder="密码" />
