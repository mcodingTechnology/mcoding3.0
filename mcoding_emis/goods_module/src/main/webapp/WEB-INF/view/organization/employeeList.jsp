    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body">
                <xingrun:accessRight menuCode="employeeList" operCode="addEmp">
...
<script src="${basePath}resources/js/custom/organization/contactList.js" type="text/javascript"></script>
