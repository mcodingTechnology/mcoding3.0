...
<div class="row">
    ...
    <div class="col-md-9">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body">
                <xingrun:accessRight menuCode="organizationList" operCode="addOrg">
...
<script src="${basePath}resources/js/custom/organization/organizationList.js" type="text/javascript"></script>
