	...
	<div class="col-md-12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-globe"></i>微社区模块管理
				</div>
			</div>
			<div class="portlet-body">
				<div class="table-toolbar">
					<div class="btn-group">
						<span class="ajaxify" href="addCompanyPageView.html">
							<span class="btn green fileinput-button">
								<i class="fa fa-plus"></i><span>添加一级分类</span>
							</span>
						</span>
						<span class="ajaxify" href="addCompanyPageView.html">
							<span class="btn green fileinput-button">
								<i class="fa fa-plus"></i><span>添加二级分类</span>
							</span>
						</span>
					</div>
				</div>
