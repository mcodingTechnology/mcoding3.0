...
<html>
	...
	<body>
		...
		<!-- Input page start -->
		<div id="id_login_page" class="cls_block cls_hidden">
			<div class="cls_logo"><img src="<%= basePath%>resources/images/merriplus_logo2.png"></div>

			<div class="cls_info_block">
				<div class="cls_declaration">
					<div>辨真伪</div>
					<div>赢积分</div>
				</div>

				<div id="cls_tips" class="cls_tips"></div>
				...
				<form id="id_securityCode_form" class="cls_input_block">
					...
					<div class="cls_oneLine">
              		...
              		<div id="id_submit_btn" onclick="scanApp.submitForm()" class="cls_button cls_disable">立即积分</div>
			</div>
		</div>
		<!-- Input page end -->
		<!-- 百度网站统计 star -->
