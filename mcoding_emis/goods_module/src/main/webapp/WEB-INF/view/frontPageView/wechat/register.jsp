			   		...
			   		$.ajax({
			               ...
			               success: function (data) {
			               		if (data.code == 0) {
				    				...
				    				$('#id_verification_code_tips_text').html('我们将向您的手机号发送一条验证码短信 <span style="color:#FF8F12;"> '+globalCounter+' </span>秒内有效');
			...
			<form id="id_register_form">
				...
				<div class="cls_box cls_no_top_border">
					...
					<div class="cls_yzm_block">
						...
						<span onclick="getVerificationCode()" id="getCode">获取验证码</span>
