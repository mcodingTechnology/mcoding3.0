...
<html>
	...
	<body>
		...
		<div class="cls_block_bg">
			<div class="cls_capsule_tips">
				<div><img src="<%= basePath%>resources/images/capsule.png"></div>
				<div>
			...
			<%-- <form id="id_securityCode_form" class="cls_input_block2">
				...
				<input id="id_securityCode_input" name="securityCode" type="tel" placeholder="请输入16位防伪码" style="font-size: 17px;"></div>
   			 	...
   			 	<div  class="cls_button_scanicon"><img src="<%= basePath%>resources/css/images/scancode.png"></div>
	...
	<script>
		...
		wx.config({
  		    ...
  		    appId: 'wx4cd8d60cd66ac9e3', // 必填，公众号的唯一标识
		...
		function validateSecurityCodeInfo(){
            ...
            mrmj.showLoader();
            var param = "openid="+openid+"&securityCode="+securityCode+"&id_barCode_input="+id_barCode_input+"&brandCode=MRMJ";
    		...
    		$.ajax({
                ...
                success: function (data) {
                	...
                	if (data.status == 0) {
                		$("#integration_fail").html("");
                		$("#id_result").html("");
                		$("#id_result").append("<div><img src='http://v.merryplus.com/resources/images/integration_success.png'></div>"+
                    	...
                    	$("#integration_fail").append("<div class='cls_integration_info2'>"+
								"<img src='http://v.merryplus.com/resources/css/images/integration_fail.png'> "+data.msg+"</div>"+	
                    	...
                    	$("#integration_fail").html("<div class='cls_integration_info2'>"+
								"<img src='http://v.merryplus.com/resources/css/images/integration_fail.png'> "+data.msg+"</div></br>"+	
            					"<div class='cls_label3'>您亦可打4009-313-999， 由客服人员协助您解决问题</div>");
