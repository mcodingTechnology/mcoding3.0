...
<html>
	<head>
		...
		<title>个人中心</title>
		<link rel="stylesheet" href="<%= basePath%>resources/css/mrmjWeChat.css" />
		...
		<div class="cls_block_bg">
			<div class="cls_personal_center">
				<div class="cls_gap"></div>
					...
					<span style="font-size:24px;color:#333;vertical-align:middle;font-family:微软雅黑;">
						<c:choose>
...
-webkit-border-radius:5px;font-size:12px;color:#ff6a00;background:#fff;opacity:0.48;">社会精英</span> --></div>
			...
			<div class="cls_button_group_duihuan" style="margin-top:10%;" >
					<div style="border: 2px solid #fe7613;background: #fff;">
	<a href="wechatPointView.html?brandCode=MRMJ" style="color:#fe7613"><i class="fa fa-qrcode fa-fw" style="margin-right:10px;"></i>我要积分</a></div>
				</div>
				<div class="cls_button_group_duihuan" style="margin-top:5%;">
					<div style="border: 2px solid #fe7613;background: #fff;">
	<a href="wechatPointDetailView.html?mobilePhone=${mobilePhone}&brandCode=MRMJ" style="color:#fe7613"><i class="fa fa-database fa-fw" style="margin-right:10px;"></i>积分明细</a></div>
				</div>
				<div class="cls_button_group_duihuan" style="margin-top:5%;">
					<div style="border: 2px solid #fe7613;background: #fff;">
	<a href="wechatPersonalDetailView.html?mobilePhone=${mobilePhone}&brandCode=MRMJ" style="color:#fe7613"><i class="fa fa-credit-card fa-fw" style="margin-right:10px;"></i>个人资料</a></div>
				</div>
			</div>
		</div>
