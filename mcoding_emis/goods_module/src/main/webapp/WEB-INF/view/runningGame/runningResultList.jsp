...
<script src="${basePath}resources/js/custom/runningGame/runningResultList.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->

<script type="text/javascript">
running_runningResultList.init();
</script>
