    ...
    <div class="col-md-9">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body" >
             ...
             <xingrun:accessRight menuCode="menuModuleConf" operCode="addOperator">
...
<script type="text/javascript" src="${basePath}resources/js/custom/system/menuManager.js"></script>
