...
var game_gameTitleList = function() {
							...
							$(nTd)
									.append(
											"<span style='margin: 0 5px 0 5px'><span class='btn btn-xs purple ajaxify'"
													+ " href='updateWarehousePageView.html?warehouseId="
													+ oData.id
	...
	var loadTableData = function() {
		...
		if(selectWarehouseName){
			reqUrl="queryWarehouseByPage?warehouseName="+selectWarehouseName;
		}else{
			reqUrl="queryWarehouseByPage";
		}
