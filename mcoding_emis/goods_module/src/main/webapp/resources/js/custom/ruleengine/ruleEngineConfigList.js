...
var RuleEngine_RuleEngineConfigList = function () {
    ...
    var initTableHeaderInfo = function(){
        ...
        var aoColumnDefs =[];
			...
			},
			{
            	...
            	"sVisible" : false,
            	"fnCreatedCell" : function(nTd, sData, oData, iRow, iCol) {
            		if(oData.brandCode=="lyl"){
            			$(nTd).append("<label class='label label-success'>蓝月亮</label>");
            		}else if(oData.brandCode=="fllk"){
            			$(nTd).append("<label class='label label-primary'>法兰琳卡</label>");
            		}else if(oData.brandCode=="sgj"){
            			$(nTd).append("<label class='label label-primary'>时光姬</label>");
            		}
    ...
    var loadTableData = function(){
        ...
        oTable = $('#'+tableId).DataTable({
            ...
            "sAjaxSource": "queryRuleEngineConfigByPage",
    ...
    var initToolBar = function(){
        ...
        $("#deleteBut").on("click", function(){
            ...
            $.ajax({
                type: "post",
                data: param,
                url: 'deleteRuleEngineConfigById',
