...
var memberPoint_memberPointList = function () {
            ...
            aoColumns.push({
            	...
            	"fnCreatedCell": function(nTd,sData, oData, iRow, iCol){
            		if(App.checkUserOperRight("memberList", "deleteMemberPoint")){
            			$(nTd).append("<span style='margin: 0 5px 0 5px'><span class='btn default btn-xs black' data-toggle='modal' href='#confirmWin' id="+oData.memberPointId+"><i class='fa fa-trash-o'></i> 删除 </span>");
            		}
            	}
            });
    ...
    var loadTableData = function(){
        ...
        oTable = $('#'+tableId).DataTable({
            ...
            "sAjaxSource": "queryMemberPointData",
