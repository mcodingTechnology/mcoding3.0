...
var health_addHealthCriteriaMemberList = function () {
    ...
    var initEvent = function () {
        ...
        $("#singleAdd").on("click", function(){
           ...
           if(!callMyvalidate()){
            ...
            setAnalysis();
            var requestURL = "addHealthCriteriaMember";
            var tips = "增加失败!";
            if($("#id").val() != ''){
                requestURL = "addHealthCriteriaMember";
                tips = "修改失败!";
            }
	...
	/*   $("#onehealthcriteriaid").on("change", function(){
		   ...
		   $.ajax({
               type : "post",
               dataType : "json",
               url : "queryResultByHealthcriteriaid",
