package com.els.runhe.cms.service.article.impl;
...
public class ArticleServiceImpl implements ArticleService {
	...
	@Transactional
	@Override
	public void deleteObjById(Integer articleId) {
...
//		this.recommendArticleService.deleteByArticleId(articleId);
	...
	@Override
	public Article queryObjById(Integer id) {
...
//		.andArticleStateEqualTo(Article.STATE_PUBLISHED);
	...
	public PageView<Article> selectLikeByPage(int pageNo,
		...
		PageView<Article> pageView = new PageView<Article>(pageNo,
				pageSize);
		Map<String, Object> map = new HashMap<String, Object>();
