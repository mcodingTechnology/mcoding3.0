package com.els.runhe.cms.entity.comment;
...
public class CommentExample extends AbstractExample<Comment> implements Serializable {
    ...
    protected PageView<Comment> pageView = new PageView<Comment>(1, 10);
