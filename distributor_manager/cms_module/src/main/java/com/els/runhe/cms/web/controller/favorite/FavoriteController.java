package com.els.runhe.cms.web.controller.favorite;
...
public class FavoriteController {
	...
	@ResponseBody
	public ResponseResult<String> likeOrDislike(int type, int status,
...
//		return favoriteService.likeOrDislike(type, status, member.getId(), articleId, StoreUtils.getStoreIdFromThreadLocal());
		return favoriteService.likeOrDislike(type, status, member.getId(), articleId, 0);
	}
	...
	@ResponseBody
	public ResponseResult<Favorite> find(int articleId, int type,
...
//				articleId, type, StoreUtils.getStoreIdFromThreadLocal());
	 ...
	 * @return
	 */
	public Favorite findFavorite(String memberId, int articleId, int type,
			int storeId) {
