...
@ApiModel(value="安全库存流水")
public class StockSafetyLog implements Serializable {
    @ApiModelProperty("主键")
    private String id;

    @ApiModelProperty("安全库存ID")
    private String stockSafetyId;
    ...
    public String getStockSafetyId() {
        return stockSafetyId;
    }

    public void setStockSafetyId(String stockSafetyId) {
        this.stockSafetyId = stockSafetyId == null ? null : stockSafetyId.trim();
    }
