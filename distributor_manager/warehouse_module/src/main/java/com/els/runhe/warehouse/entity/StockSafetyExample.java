...
public class StockSafetyExample extends AbstractExample<StockSafety> implements Serializable {
    ...
    protected PageView<StockSafety> pageView = new PageView<StockSafety>(1, 10);

    private static final long serialVersionUID = 1L;

    public StockSafetyExample() {
    ...
    @Override
    public PageView<StockSafety> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<StockSafety> pageView) {
