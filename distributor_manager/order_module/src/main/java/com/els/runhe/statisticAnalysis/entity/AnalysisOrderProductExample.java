...
public class AnalysisOrderProductExample extends AbstractExample<AnalysisOrderProduct> implements Serializable {
    ...
    protected PageView<AnalysisOrderProduct> pageView = new PageView<AnalysisOrderProduct>(1, 10);

    private static final long serialVersionUID = 1L;

    public AnalysisOrderProductExample() {
    ...
    @Override
    public PageView<AnalysisOrderProduct> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<AnalysisOrderProduct> pageView) {
