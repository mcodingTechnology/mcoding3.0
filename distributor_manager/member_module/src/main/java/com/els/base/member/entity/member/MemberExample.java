package com.els.base.member.entity.member;
...
public class MemberExample extends AbstractExample<Member> implements Serializable {
    ...
    protected PageView<Member> pageView = new PageView<Member>(1, 10);
