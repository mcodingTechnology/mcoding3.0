...
import com.els.base.member.service.setting.MemberSettingValueService;
...
public class MemberSettingValueController {
    ...
    @ResponseBody
    public ResponseResult<String> create(@RequestBody MemberSettingValue memberSettingValue) {
    ...
    @ResponseBody
    public ResponseResult<String> edit(@RequestBody MemberSettingValue memberSettingValue) {
