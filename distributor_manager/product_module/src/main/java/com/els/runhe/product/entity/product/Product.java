...
//	############后期添加的，请不要覆盖####################
    ...
    @ApiModelProperty("积分兑换量")
    private Integer giftExchangeNum;
    ...
    public Integer getGiftExchangeNum() {
        return giftExchangeNum;
    }

    public void setGiftExchangeNum(Integer giftExchangeNum) {
        this.giftExchangeNum = giftExchangeNum;
    }
